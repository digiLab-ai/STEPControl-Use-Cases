...
Nchannels = 10  # number of potential lines of sight
los_starts = [
    (0.91, -0.1),
    (0.91, 0.3),
    (0.7, 0.55),
    ...
    (0.17, -0.3),
    (0.4, -0.55),
]  # potential imaging system loc
thetas = [0.7]  # spread of the channels
diagnosticTypes = [
    BolometerCamera,
    BremsstrahlungDiode,
]  # type of diagnostics to choose from
...
radiation = np.zeros(el_density_2d.shape)
for impurity in list(impurities):
...
filename = outFolder + "Imaging_states_handsOff_" + impName + ".nc"
...
filename = outFolder + "Imaging_geometry_handsOff.csv"
...
filename = outFolder + "Imaging_measurements_handsOff_" + impName + ".csv"
